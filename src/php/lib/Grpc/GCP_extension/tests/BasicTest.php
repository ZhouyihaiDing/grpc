...
class CallCredentialsTest extends PHPUnit_Framework_TestCase
{
  ...
  public function testCreateSessionReuseChannel()
  {
    ...
    for ($i = 0; $i < $this->_DEFAULT_MAX_CHANNELS_PER_TARGET; $i++) {
      ...
      $this->assertStatusOk($status);
      $result = (count($this->call_invoker->_getChannel()->getChannelRefs()) == 1);
  ...
  public function testCreateSessionNewChannel()
  {
    ...
    for ($i = 0; $i < $this->_DEFAULT_MAX_CHANNELS_PER_TARGET; $i++) {
      ...
      $create_session_request->setDatabase($this->database);
      $create_session_call = $this->stub->CreateSession($create_session_request);
      $result = (count($this->call_invoker->_getChannel()->getChannelRefs()) == $i + 1);
      $this->assertEquals($i + 1, count($this->call_invoker->_getChannel()->getChannelRefs()));
    ...
    for ($i = 0; $i < $this->_DEFAULT_MAX_CHANNELS_PER_TARGET; $i++) {
      ...
      $this->assertStatusOk($status);
      $result = (count($this->call_invoker->_getChannel()->getChannelRefs()) == $this->_DEFAULT_MAX_CHANNELS_PER_TARGET);
      $this->assertEquals($this->_DEFAULT_MAX_CHANNELS_PER_TARGET,
        count($this->call_invoker->_getChannel()->getChannelRefs()));
    }
  ...
  public function testConcurrentStreamsWatermark()
  {
    ...
    $this->assertEquals(2, $this->call_invoker->_getChannel()->getChannelRefs()[1]->getAffinityRef());
    $this->assertEquals(2, $this->call_invoker->_getChannel()->getChannelRefs()[1]->getActiveStreamRef());
    $this->assertEquals(1, $this->call_invoker->_getChannel()->getChannelRefs()[0]->getAffinityRef());
    $this->assertEquals(0, $this->call_invoker->_getChannel()->getChannelRefs()[0]->getActiveStreamRef());
    ...
    $this->assertEquals(2, $this->call_invoker->_getChannel()->getChannelRefs()[1]->getActiveStreamRef());
    $this->assertEquals(1, $this->call_invoker->_getChannel()->getChannelRefs()[0]->getAffinityRef());
    $this->assertEquals(1, $this->call_invoker->_getChannel()->getChannelRefs()[0]->getActiveStreamRef());
    ...
    for ($i=0; $i < $this->_WATER_MARK; $i++) {
      ...
      $this->assertEquals($exec_sql_reply->getRows()[0]->getValues()[0]->getStringValue(), $result[0]);
      $this->assertEquals(2, count($this->call_invoker->_getChannel()->getChannelRefs()));
      $this->assertEquals(2 - $i, $this->call_invoker->_getChannel()->getChannelRefs()[1]->getAffinityRef());
      $this->assertEquals(1 - $i, $this->call_invoker->_getChannel()->getChannelRefs()[1]->getActiveStreamRef());
      $this->assertEquals(0, $this->call_invoker->_getChannel()->getChannelRefs()[0]->getAffinityRef());
      $this->assertEquals(0, $this->call_invoker->_getChannel()->getChannelRefs()[0]->getActiveStreamRef());
      ...
      list($session, $status) = $this->stub->DeleteSession($delete_session_request)->wait();
      $this->assertEquals(2, count($this->call_invoker->_getChannel()->getChannelRefs()));
      $this->assertEquals(1 - $i, $this->call_invoker->_getChannel()->getChannelRefs()[1]->getAffinityRef());
      $this->assertEquals(1 - $i, $this->call_invoker->_getChannel()->getChannelRefs()[1]->getActiveStreamRef());
      $this->assertEquals(0, $this->call_invoker->_getChannel()->getChannelRefs()[0]->getAffinityRef());
      $this->assertEquals(0, $this->call_invoker->_getChannel()->getChannelRefs()[0]->getActiveStreamRef());
    }
