...
class ChannelTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50000',
            ['credentials' => Grpc\ChannelCredentials::createInsecure()]);
        $this->assertSame('Grpc\GCP\GrpcExtensionChannel', get_class($this->channel));
    }

    public function testGetConnectivityState()
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50001',
             ['credentials' => Grpc\ChannelCredentials::createInsecure()]);
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50002',
             ['credentials' => Grpc\ChannelCredentials::createInsecure()]);
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50003',
             ['credentials' => Grpc\ChannelCredentials::createInsecure()]);
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50004',
             ['credentials' => Grpc\ChannelCredentials::createInsecure()]);
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50005',
             ['credentials' => Grpc\ChannelCredentials::createInsecure()]);
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50006',
             ['credentials' => Grpc\ChannelCredentials::createInsecure()]);
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50007',
             ['credentials' => Grpc\ChannelCredentials::createInsecure()]);
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel();
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50008', 'invalid');
        $this->assertNull($this->channel);
    }
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50009',
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50010',
            ['abc' => []]);
    }
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50011',
            ['credentials' => Grpc\ChannelCredentials::createInsecure()]);
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50012',
            ['credentials' => Grpc\ChannelCredentials::createInsecure()]);
    ...
    {
        $this->channel = new Grpc\GCP\GrpcExtensionChannel('localhost:50013',
            ['credentials' => Grpc\ChannelCredentials::createInsecure()]);
    ...
    {
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50014', [
            "grpc_target_persist_bound" => 3,
        ]);
        // the underlying grpc channel is the same by default
        // when connecting to the same host
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50014', []);
    ...
    public function testPersistentChannelDifferentHost()
    {
        ...
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50015', [
            "grpc_target_persist_bound" => 3,
        ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50016', []);
    ...
    {
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50017', [
          "grpc_target_persist_bound" => 3,
          "abc" => "def",
          ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50017', ["abc" => "def"]);
    ...
    {
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50018', [
            "grpc_target_persist_bound" => 3,
          ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50018', ["abc" => "def"]);
    ...
    public function testPersistentChannelSameChannelCredentials()
    {
        ...
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50019',
                                           ["credentials" => $creds1,
                                             "grpc_target_persist_bound" => 3,
                                             ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50019',
                                           ["credentials" => $creds2]);
    ...
    public function testPersistentChannelDifferentChannelCredentials()
    {
        ...
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50020',
                                           ["credentials" => $creds2]);
    ...
    public function testPersistentChannelSameChannelCredentialsRootCerts()
    {
        ...
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50021',
                                           ["credentials" => $creds2]);
    ...
    public function testPersistentChannelDifferentSecureChannelCredentials()
    {
        ...
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50022',
                                           ["credentials" => $creds1,
                                             "grpc_target_persist_bound" => 3,
                                             ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50022',
                                           ["credentials" => $creds2]);
    ...
    public function testPersistentChannelSharedChannelClose1()
    {
        ...
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50123', [
            "grpc_target_persist_bound" => 3,
        ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50123', []);
    ...
    {
        // same underlying channel
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50223', [
            "grpc_target_persist_bound" => 3,
        ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50223', []);
    ...
    {
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50024', [
            "grpc_target_persist_bound" => 3,
        ]);

        $this->channel1->close();

        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50024', []);
        $state = $this->channel2->getConnectivityState();
        $this->assertEquals(GRPC\CHANNEL_IDLE, $state);
    ...
    {
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50025', [
            "grpc_target_persist_bound" => 3,
        ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50025', []);
        $this->channel3 = new Grpc\GCP\GrpcExtensionChannel('localhost:50025', []);
    ...
    public function testPersistentChannelWithCallCredentials()
    {
        ...
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50026',
                                           ["credentials" =>
                                            $credsWithCallCreds,
                                            "grpc_target_persist_bound" => 3,
                                            ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50026',
                                           ["credentials" =>
                                            $credsWithCallCreds]);
    ...
    public function testPersistentChannelWithDifferentCallCredentials()
    {
        ...
        // persisted
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50027',
                                           ["credentials" => $creds1,
                                            "grpc_target_persist_bound" => 3,
                                            ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50027',
                                           ["credentials" => $creds2]);
        $this->channel3 = new Grpc\GCP\GrpcExtensionChannel('localhost:50027',
                                           ["credentials" => $creds3]);
    ...
    {
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50028', [
        ...
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50028',
                                           ["force_new" => true]);
    ...
    public function testPersistentChannelForceNewOldChannelIdle1()
    {
        ...
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50029', [
            "grpc_target_persist_bound" => 2,
        ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50029',
                                           ["force_new" => true]);
        // channel3 shares with channel1
        $this->channel3 = new Grpc\GCP\GrpcExtensionChannel('localhost:50029', []);
    ...
    public function testPersistentChannelForceNewOldChannelClose1()
    {
        ...
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50130', [
            "grpc_target_persist_bound" => 2,
        ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50130',
                                           ["force_new" => true]);
        // channel3 shares with channel1
        $this->channel3 = new Grpc\GCP\GrpcExtensionChannel('localhost:50130', []);
    ...
    public function testPersistentChannelForceNewOldChannelClose2()
    {
        ...
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50230', [
            "grpc_target_persist_bound" => 2,
        ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50230',
          ["force_new" => true]);
        // channel3 shares with channel1
        $this->channel3 = new Grpc\GCP\GrpcExtensionChannel('localhost:50230', []);
    ...
    public function testPersistentChannelForceNewNewChannelClose()
    {
        ...
        $this->channel1 = new Grpc\GCP\GrpcExtensionChannel('localhost:50031', [
            "grpc_target_persist_bound" => 2,
        ]);
        $this->channel2 = new Grpc\GCP\GrpcExtensionChannel('localhost:50031',
                                           ["force_new" => true]);
        $this->channel3 = new Grpc\GCP\GrpcExtensionChannel('localhost:50031', []);
